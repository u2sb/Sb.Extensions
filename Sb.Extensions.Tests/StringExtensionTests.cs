...
public class StringExtensionTests
{
  ...
  {
    var result = input.TryParseToInt32(out var v);
  ...
  {
    var result = input.TryParseToByte(out var v);
    Assert.Equal(expected, result);
    if (expected) Assert.Equal(value, v);
  }
  ...
  {
    var result = input.TryParseToFloat(out var v);
    Assert.Equal(expected, result);
    if (expected) Assert.Equal(value, v);
  }
  ...
  {
    var result = input.TryParseToDouble(out var v);
    Assert.Equal(expected, result);
    if (expected) Assert.Equal(value, v);
  }
